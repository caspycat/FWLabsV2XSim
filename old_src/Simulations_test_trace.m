...
WiLabV2Xsim(configFile,...
    'output.Directory',outputFolder, "filenameTrace", dirTraceFile,...
    'simulation.RadioAccessMode','5G-V2X', 'nrV2x.Mcs',MCS, 'nrV2x.SubcarrierSpacingKilohertz',SCS, 'application.PacketSizeBytes',packetSize,...
    'simulation.DurationSeconds',simTime, 'resourceAllocation.Autonomous.KeepResourceProbability',pKeep, 'radio.BandwidthMHz',BandMHz,...
