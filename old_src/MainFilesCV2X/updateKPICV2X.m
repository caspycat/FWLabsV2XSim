...
% From v 5.4.14
[fateRxListRawMax,stationManagement,sinrManagement, ...
    interferenceDiagnostics] = elaborateFateRxCV2X( ...
        timeManagement,activeIDsTXLTE,indexInActiveIDsOnlyLTE, ...
        neighborsID_LTE,sinrManagement,stationManagement, ...
...
if isfield(simParams,"interferenceClassificationEnabled") && ...
        simParams.interferenceClassificationEnabled
    dispatchAfterInterferenceEvidenceDetermined( ...
        simValues,timeManagement.timeNow,simParams.stringCV2X, ...
        stationManagement,activeIDsTXLTE, ...
        timeManagement.timeGeneratedPacketInTxLTE(activeIDsTXLTE), ...
