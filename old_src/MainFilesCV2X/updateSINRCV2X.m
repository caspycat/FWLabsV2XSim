...
if ~isempty(transmittingIDsCV2X)
    ...
    if isfield( ...
            ...
            sinrManagement.cv2xInterferenceEvidenceEnabled
        % Every explicitly enumerated C-V2X contributor is stored
        % separately. This residual contains thermal noise and, for
        % coexistence runs, aggregate 11p interference that cannot be
        % assigned a fabricated UE identity.
        sinrManagement. ...
            cv2xCounterfactualUnattributedDenominatorPower = ...
            PnoiseData + neighborsInterf11p;
    end
