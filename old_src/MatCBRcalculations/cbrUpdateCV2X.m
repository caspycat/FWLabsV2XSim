...
if simParams.technology == constants.TECH_COEX_STD_INTERF
    ...
    if ~isempty(vehiclesToConsider) && timeManagement.elapsedTime_TTIs > nAllocationPeriodsCBR * appParams.NbeaconsT
        if simParams.coexMethod>1 && simParams.coex_slotManagement==2 && simParams.coex_printTechPercentage
            filenameTechP = fullfile( ...
                outParams.outputFolder, ...
                "coexistence_technology_share.csv");
            writeTechnologyShareHeader = ~isfile(filenameTechP);
            ...
            if fpTechP == -1
                ...
                if fpTechP == -1
                    error( ...
                        "v2xsim:output:FileOpenFailed", ...
                        "Could not open output file: %s", ...
                        filenameTechP);
                end
            end
            if writeTechnologyShareHeader
                fprintf(fpTechP, ...
                ...
                if ~ismember(simParams.coexMethod, [constants.COEX_METHOD_NON, constants.COEX_METHOD_A]) &&...
                    ...
                    if simParams.coex_cbrTotVariant == 1
                        fprintf(fpTechP,'%f,%d,%f,%f,%f,%d\n', ...
                            timeManagement.timeNow,iV, ...
                            sinrManagement.cbrCV2X_coexLTEonly(iV), ...
                            sinrManagement.cbrCV2X(iV), ...
                            Tech_percentage, ...
                            sinrManagement.coex_NtotSubframeLTE(iV));
                    else
                        fprintf(fpTechP,'%f,%d,%f,%f,%f,%d\n', ...
                            timeManagement.timeNow,iV, ...
                            sinrManagement.cbrCV2X_coexLTEonly(iV), ...
                            sinrManagement.cbrCV2X_coexLTEonly(iV) + ...
                            sinrManagement.cbrCV2X_coex11ponly(iV), ...
                            Tech_percentage, ...
                            sinrManagement.coex_NtotSubframeLTE(iV));
                    end
                end
