...
switch lower(string(simParams.typeOfScenario))
    ...
    case {"roundaboutscenario", ...
        ...
        simParams.typeOfScenario = 'RoundaboutScenario';
    otherwise
        error( ...
            ...
            'EtsiHighwayScenario, ExitRampHighwayScenario, or ', ...
            'RoundaboutScenario.']);
end
...
switch simParams.typeOfScenario
    ...
    case 'RoundaboutScenario'
        [simParams,varargin] = addNewParam( ...
            ...
            'Number of vehicles','integer',fileCfg,varargin{1});
        [simParams,varargin] = addNewParam( ...
            simParams,'scenarioOptions.ExitLengths',500, ...
            'North/east/south/west arm lengths (m)','double', ...
            fileCfg,varargin{1});
        [simParams,varargin] = addNewParam( ...
            simParams,'scenarioOptions.RoadWidth',4, ...
            'One-way road and circulating-lane width (m)','double', ...
            fileCfg,varargin{1});
        [simParams,varargin] = addNewParam( ...
            simParams,'scenarioOptions.InnerCircleDiameter',60, ...
            'Inner-circle diameter (m)','double',fileCfg,varargin{1});
        [simParams,varargin] = addNewParam( ...
            simParams,'scenarioOptions.MeanVehicleSpeed',20, ...
            'Mean vehicle speed (m/s)','double',fileCfg,varargin{1});
        [simParams,varargin] = addNewParam( ...
            simParams, ...
        ...
        [simParams,varargin] = addNewParam( ...
            simParams,'scenarioOptions.RerollSpeedOnWrapAround',true, ...
            'Reroll speed after route recycling','bool', ...
            fileCfg,varargin{1});
end
