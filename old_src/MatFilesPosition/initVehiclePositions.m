...
switch typeOfScenario
    case 'BrownianMotionScenario'
        scenario = ...
            v2xsim.vehicle.scenarios.BrownianMotionScenario( ...
                ...
                RandomSeed=scenarioOptions.RandomSeed, ...
                SimulationAreaSize= ...
    ...
    case 'RoundaboutScenario'
        scenario = v2xsim.vehicle.scenarios.RoundaboutScenario( ...
            scenarioOptions.VehicleCount, ...
            RandomSeed=scenarioOptions.RandomSeed, ...
            ExitLengths=scenarioOptions.ExitLengths, ...
            RoadWidth=scenarioOptions.RoadWidth, ...
            InnerCircleDiameter= ...
                scenarioOptions.InnerCircleDiameter, ...
            MeanVehicleSpeed=scenarioOptions.MeanVehicleSpeed, ...
            VehicleSpeedStandardDeviation= ...
                scenarioOptions.VehicleSpeedStandardDeviation, ...
            RerollSpeedOnWrapAround= ...
                scenarioOptions.RerollSpeedOnWrapAround);
...
if isa(scenario,'v2xsim.vehicle.scenarios.RoundaboutScenario')
    outerRadius = scenario.InnerCircleDiameter / 2 + ...
        scenario.RoadWidth;
    exitLengths = scenario.ExitLengths;
    positionManagement.Xmin = -(outerRadius + exitLengths(4));
    positionManagement.Xmax = outerRadius + exitLengths(2);
    positionManagement.Ymin = -(outerRadius + exitLengths(3));
    positionManagement.Ymax = outerRadius + exitLengths(1);
    return
end
