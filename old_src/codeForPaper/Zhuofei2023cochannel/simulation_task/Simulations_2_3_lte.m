...
stopTimesByDensity = 10 * ones(size(dens_km));
stopTimesByDensity(dens_km < 10) = 40;
stopTimesByDensity(dens_km >= 10 & dens_km < 20) = 30;
stopTimesByDensity(dens_km >= 20 & dens_km <= 30) = 20;
