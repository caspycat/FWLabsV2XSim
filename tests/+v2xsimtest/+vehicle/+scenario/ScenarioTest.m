classdef ScenarioTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function testDynamicStepAcceptsExactLifecycleAlgebra(testCase)
            import v2xsim.vehicle.scenario.VehicleLifecycleTransition
            ...
            transitions = table( ...
                ...
                RowNames=["B", "A", "C"]);
            scenario = ...
                v2xsimtest.vehicle.scenario.fixture.DynamicScenarioStub( ...
                    initialKinematics, nextKinematics, transitions);

            [scenario, actualTransitions] = scenario.step(0.25);

            testCase.verifyEqual( ...
                scenario.VehicleKinematics, nextKinematics);
            testCase.verifyEqual(actualTransitions, transitions);
            testCase.verifyEqual(scenario.LastDeltaTime, 0.25);
        end

        function testDynamicStepRequiresUnionOfIdentitySets(testCase)
            import v2xsim.vehicle.scenario.VehicleLifecycleTransition
        ...
        function testDynamicStepRequiresExactTransitionLabels(testCase)
            import v2xsim.vehicle.scenario.VehicleLifecycleTransition
            ...
            for invalidIdentityIndex = 1:3
                ...
                transitions = table( ...
                    ...
                    RowNames=["A", "B", "C"]);
                scenario = ...
                    v2xsimtest.vehicle.scenario.fixture. ...
                    DynamicScenarioStub( ...
                        initialKinematics, nextKinematics, transitions);
        ...
        function testDynamicStepSupportsEmptyPopulationBoundaries(testCase)
            import v2xsim.vehicle.scenario.VehicleLifecycleTransition

            populatedKinematics = testCase.createKinematics( ...
                ["A", "B"], 0);
            emptyKinematics = testCase.createKinematics( ...
                strings(0, 1), 0);
            exitTransitions = table( ...
                repmat(VehicleLifecycleTransition.Exited, 2, 1), ...
                VariableNames="Transition", ...
                RowNames=["A", "B"]);
            exitScenario = ...
                v2xsimtest.vehicle.scenario.fixture.DynamicScenarioStub( ...
            ...
            exitScenario = exitScenario.step(1);

            testCase.verifyEmpty(exitScenario.VehicleKinematics);

            enterTransitions = table( ...
                repmat(VehicleLifecycleTransition.Entered, 2, 1), ...
                VariableNames="Transition", ...
                RowNames=["A", "B"]);
            enterScenario = ...
                v2xsimtest.vehicle.scenario.fixture.DynamicScenarioStub( ...
            ...
            enterScenario = enterScenario.step(1);

            testCase.verifyEqual( ...
                enterScenario.VehicleKinematics, populatedKinematics);
        end
